package com.mobai.root.magica;

import static com.mobai.root.magica.AppZygotePreload.TAG;
...
import com.mobai.root.ui.util.KsuCliKt;
...
public class BootCompletedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!Intent.ACTION_LOCKED_BOOT_COMPLETED.equals(action)
                ...
                && !"com.mobai.root.magica.LAUNCH".equals(action)) {
            return;
        }
