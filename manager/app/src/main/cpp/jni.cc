...
Java_com_mobai_root_Natives_getVersion(JNIEnv *env, jobject) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_mobai_root_Natives_getSuperuserCount(JNIEnv *env, jobject) {
...
Java_com_mobai_root_Natives_isSafeMode(JNIEnv *env, jclass clazz) {
    return is_safe_mode();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_mobai_root_Natives_isLkmMode(JNIEnv *env, jclass clazz) {
    return is_lkm_mode();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_mobai_root_Natives_isLateLoadMode(JNIEnv *env, jclass clazz) {
    return is_late_load_mode();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_mobai_root_Natives_isManager(JNIEnv *env, jclass clazz) {
    return is_manager();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_mobai_root_Natives_isPrBuild(JNIEnv *env, jclass clazz) {
    return is_pr_build();
}
...
Java_com_mobai_root_Natives_getAppProfile(JNIEnv *env, jobject, jstring pkg, jint uid) {
    ...
    auto cls = env->FindClass("com/mobai/ultra/Natives$Profile");
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_mobai_root_Natives_setAppProfile(JNIEnv *env, jobject clazz, jobject profile) {
    auto cls = env->FindClass("com/mobai/ultra/Natives$Profile");
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_mobai_root_Natives_uidShouldUmount(JNIEnv *env, jobject thiz, jint uid) {
    return uid_should_umount(uid);
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_mobai_root_Natives_isSuEnabled(JNIEnv *env, jobject thiz) {
    return is_su_enabled();
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_mobai_root_Natives_setSuEnabled(JNIEnv *env, jobject thiz, jboolean enabled) {
    return set_su_enabled(enabled);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_mobai_root_Natives_isKernelUmountEnabled(JNIEnv *env, jobject thiz) {
    return is_kernel_umount_enabled();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_mobai_root_Natives_setKernelUmountEnabled(JNIEnv *env, jobject thiz, jboolean enabled) {
    return set_kernel_umount_enabled(enabled);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_mobai_root_Natives_isSelinuxHideEnabled(JNIEnv *env, jobject thiz) {
    return is_selinux_hide_enabled();
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_mobai_root_Natives_setSelinuxHideEnabled(JNIEnv *env, jobject thiz, jboolean enabled) {
    return set_selinux_hide_enabled(enabled);
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_mobai_root_Natives_getUserName(JNIEnv *env, jobject thiz, jint uid) {
...
Java_com_mobai_root_magica_AppZygotePreload_forkDontCareAndExecKsud(JNIEnv *env, jclass clazz,
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_mobai_root_Natives_getFullVersion(JNIEnv *env, jobject) {
    char buff[255] = {};
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_mobai_root_Natives_getHookType(JNIEnv *env, jobject) {
    char hook_type[32] = {};
