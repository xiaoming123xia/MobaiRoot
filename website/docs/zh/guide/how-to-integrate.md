...
MobaiRoot 可以集成到 GKI 和 non-GKI 内核中，并且已反向移植到 4.14 版本。

<!-- 应该是 3.4 版本，但 backslashxx 的 syscall manual hook 无法在 MobaiRoot 中使用-->
...
3. **Tracepoint Hook:**
   - 自 MobaiRoot commit [49b01aad](https://github.com/MobaiRoot-Ultra/MobaiRoot-Ultra/commit/49b01aad74bcca6dba5a8a2e053bb54b648eb124) 引入的 hook 方法
...
将 KernelSU（MobaiRoot）添加到内核源代码树的步骤的运行命令将被替换为：
...
- `main` (susfs-main)
- `test` (susfs-test)
- 版本号 (例如: susfs-1.5.7, 你需要在 [分支](https://github.com/MobaiRoot-Ultra/MobaiRoot-Ultra/branches) 里找到它)
