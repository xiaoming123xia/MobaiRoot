...
了解如何在您的设备上 **[安装](./installation)** MobaiRoot-Ultra

## 如何集成

阅读 **[集成](./how-to-integrate.md)** 将 MobaiRoot 集成到你的内核中
...
- **错误报告**: [GitHub Issues](https://github.com/MobaiRoot-Ultra/MobaiRoot-Ultra/issues)
- **直接支持**: 联系开发者处理关键问题
