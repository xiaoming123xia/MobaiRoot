...
This guide provides comprehensive instructions for installing MobaiRoot-Ultra on your Android device. Please follow the steps carefully.
...
There are several ways to install MobaiRoot-Ultra, depending on your device and preference.
...
3.  **Verify Installation**:
    - [ ] Install the MobaiRoot-Ultra Manager app.
...
- **SUSFS-Dev Branch (Recommended)**:
  ```sh [bash]
  curl -LSs "https://raw.githubusercontent.com/MobaiRoot-Ultra/MobaiRoot-Ultra/main/kernel/setup.sh" | bash -s susfs-main
  ```
...
1.  **Flash to Inactive Slot**:
    ...
    - [ ] Open the MobaiRoot-Ultra Manager.
...
- [ ] **Manager App**: The MobaiRoot-Ultra Manager app opens and shows a successful root status.
- [ ] **Root Access**: Root checker apps confirm that root access is working.
- [ ] **Kernel Version**: The kernel version in `Settings > About Phone` reflects the MobaiRoot-Ultra kernel.
