...
[![最新发行](https://img.shields.io/github/v/release/MobaiRoot-Ultra/MobaiRoot-Ultra?label=Release&logo=github)](https://github.com/tiann/KernelSU/releases/latest)
...
要将 MobaiRoot 翻译成您的语言，或完善现有的翻译，请使用 [Crowdin](https://crowdin.com/project/MobaiRoot-Ultra).
...
**开源仓库**: [https://github.com/ShirkNeko/MobaiRoot_KernelPatch_patch](https://github.com/ShirkNeko/MobaiRoot_KernelPatch_patch)
...
- [ShirkNeko](https://afdian.com/a/shirkneko) (MobaiRoot 主要维护者)
