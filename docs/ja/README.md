# MobaiRoot
<img align='right' src='MobaiRoot-mini.svg' width='220px' alt="sukisu logo">
...
オープンソースアドレス: https://github.com/ShirkNeko/MobaiRoot_KernelPatch_patch
...
**マネージャーの翻訳を行う場合** https://crowdin.com/project/MobaiRoot-Ultra

- [その他パッチ済み GKI](https://github.com/ShirkNeko/GKI_KernelSU_SUSFS) ZRAM パッチ、KPM、susfs が含まれています...
- [パッチの少ない GKI](https://github.com/MiRinFork/GKI_MobaiRoot_SUSFS/releases) susfs のみ
