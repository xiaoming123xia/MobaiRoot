...
MobaiRoot can be integrated into both _GKI_ and _non-GKI_ kernels and has been backported to _4.14_.
...
3. **Tracepoint Hook:**
   ...
   - Hook method introduced since MobaiRoot commit [49b01aad](https://github.com/MobaiRoot-Ultra/MobaiRoot-Ultra/commit/49b01aad74bcca6dba5a8a2e053bb54b648eb124)
...
Run command for the step that adds KernelSU(MobaiRoot) to your kernel source tree is replaced with:
...
- `main` (susfs-main)
- `test` (susfs-test)
- version (for example: susfs-1.5.7, you should check the [branches](https://github.com/MobaiRoot-Ultra/MobaiRoot-Ultra/branches))
