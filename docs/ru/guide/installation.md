...
Ты можешь обратиться к разделу [KernelSU Documentation - Installation](https://kernelsu.org/guide/installation.html) за базовой информацией. Ниже приведены дополнительные инструкции, специфичные для MobaiRoot.
...
- [MiRinFork flavored kernel](https://github.com/MiRinFork/GKI_MobaiRoot_SUSFS) (добавлены susfs, KPM. Максимально близкое к стоковому GKI ядро, работает на большинстве устройств).
