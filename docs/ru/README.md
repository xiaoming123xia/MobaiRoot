# MobaiRoot
<img align='right' src='MobaiRoot-mini.svg' width='220px' alt="логотип sukisu">
...
[![Latest release](https://img.shields.io/github/v/release/MobaiRoot-Ultra/MobaiRoot-Ultra?label=Release&logo=github)](https://github.com/tiann/KernelSU/releases/latest)
...
Если вы хотите предложить перевод для менеджера, пожалуйста, воспользуйтесь [Crowdin](https://crowdin.com/project/MobaiRoot-Ultra).
...
**Open-source репозиторий**: [https://github.com/ShirkNeko/MobaiRoot_KernelPatch_patch](https://github.com/ShirkNeko/MobaiRoot_KernelPatch_patch)
...
- [ShirkNeko](https://afdian.com/a/shirkneko) (поддерживает MobaiRoot)
